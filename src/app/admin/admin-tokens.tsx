    ...
    <div>
      ...
      <Card className="mb-5">
        ...
        <div className="flex flex-wrap items-end gap-3">
          ...
          <button onClick={generate} disabled={busy} className="h-10 px-5 rounded-xl font-semibold text-white disabled:opacity-50 flex items-center gap-2" style={{ background: "linear-gradient(135deg, #7C3AED, #D7B8F3)" }}>
